...
export default function BatchSelector({ product, batches, onSelect, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      {/* Panel */}
      <div className="relative w-full max-w-lg rounded-2xl shadow-2xl border border-white/20 dark:border-white/10 overflow-hidden animate-modal-in"
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200/70">
          <div>
            <h3 className="text-base font-bold text-gray-900">Select Batch</h3>
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={onClose} className="btn-icon w-7 h-7 p-1 text-gray-400">
              <X size={16} />
            </button>
          </div>
        </div>
              ...
              <button
                ...
                className={`w-full rounded-xl border-2 px-4 py-3 text-left transition-all duration-150 ${
                  isSelected
                    ...
                    : 'border-transparent bg-gray-50/80 hover:border-gray-200 hover:bg-gray-100/60'
                }`}
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      {isFirst && (
                        <span className="text-[9px] font-bold text-emerald-600 bg-emerald-100 dark:bg-emerald-900/30 px-1.5 py-0.5 rounded-md flex items-center gap-0.5">
                          ✓ FEFO First
                        </span>
                      )}
                    </div>
        ...
        {/* Footer */}
        <div className="px-5 py-4 border-t border-gray-200/70 flex items-center justify-between gap-3">
